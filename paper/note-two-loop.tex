...
\author{Jon Torrez\thanks{gmail@jontorrez.com. Computations performed in
collaboration with an AI research assistant (Claude, Anthropic); all
code at \url{https://github.com/jrtorrez31337/executable-positive-geometry}.}}
