...
| Arkani-Hamed, Thomas & Trnka, **Unwinding the Amplituhedron in Binary** (2017) | [1704.05069](https://arxiv.org/abs/1704.05069) | 🟡 | The sign-flip / binary characterization of the amplituhedron. **Source for the sign-flip charts used in `labs/track-b/05-loop-amplituhedron` (n=5, two-loop n=5/n=6)** — filed 2026-07-08 after the corpus-review pass flagged we had built on it without filing it. |
...
| Byun, Kim & Lee, **TW-Inspired Teleportation in a Chaotic Binary Sparse SYK Model** (2026) | [2604.10090](https://arxiv.org/abs/2604.10090) | 🔴 | Binary sparse SYK (retains chaos to low K) + traversable-wormhole teleportation with a sign-dependent mutual-information asymmetry, measured on a superconducting QPU (NISQ, qualitative). **Source for Track D Phase 6** (chaos diagnostics + TW protocol). |
| Collura, De Nardis, Alba & Lami, **The Non-Stabilizerness of Fermionic Gaussian States** (2024) | [2412.05367](https://arxiv.org/abs/2412.05367) | 🔴 | Fermionic Gaussian states carry *extensive* qubit-stabilizer magic (Haar-like leading order). **Cosmo-magic Project 1** fermion resource theory. |
| Iannotti, Hamma & Turkeshi et al., **Non-Local Magic Resources for Fermionic Gaussian States** (2026) | [2604.27049](https://arxiv.org/abs/2604.27049) | 🔴 | Covariance-formula nonlocal magic for fermionic Gaussian states. **Cosmo-magic Project 1** fermion cross-check anchor. |
| Haque, Jafari & Underwood, **Inflation is Not Magic** (2025) | [2512.10126](https://arxiv.org/abs/2512.10126) | 🔴 | Free bosonic inflationary two-mode-squeezed state has zero Wigner negativity despite entanglement. **Cosmo-magic Project 1** boson theorem-null (already published). |
| Ireland & Vennin, **When inflationary perturbations refuse to classicalise: the role of non-Gaussianity in Wigner negativity** (2026) | [2601.22219](https://arxiv.org/abs/2601.22219) | 🔴 | Interaction-generated primordial non-Gaussianity produces Wigner-negative interference fringes; negativity grows as a^2 in ultra-slow-roll. **Cosmo-magic Project 1c** source for the bosonic interaction turn-on. |
| **Bridging Magic and Non-Gaussian Resources via GKP Encoding** (2024) | [2406.06418](https://arxiv.org/abs/2406.06418) | 🔴 | CV magic = Wigner negativity = non-Gaussianity, linked to DV magic via GKP. **Cosmo-magic Project 1** boson resource-theory bridge. |
| Alavirad et al., **Digital Quantum Simulation of Cosmological Particle Creation (dS→radiation)** (2026) | [2605.04099](https://arxiv.org/abs/2605.04099) | 🔴 | Time-resolved cosmological particle creation simulated on IBM/Aer. **Cosmo-magic Project 1** hardware-adjacent (#5) benchmark hook. |
